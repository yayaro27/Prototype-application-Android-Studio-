...
public class Blog extends AppCompatActivity {
    ...
    class Add extends AsyncTask<String, String, String>{
        ...
        protected String doInBackground(String... strings) {
            ...
            JSONObject object=parser.makeHttpRequest("*/Lien vers le formulaire php souhaité/*","GET", map);
            return null;
        }
    ...
    class All extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            JSONObject object2=parser.makeHttpRequest("*/Lien vers le formulaire php souhaité/*","GET", map2);
